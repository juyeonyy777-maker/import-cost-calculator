    ...
    <div className="min-h-screen bg-[#f5f6fa] flex">
      ...
      <aside className="w-[200px] bg-[#1a2332] min-h-screen flex-shrink-0 flex flex-col fixed top-0 left-0 h-screen z-50">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          <button onClick={() => window.open('/cost-simulator', '_blank')} className="w-full text-left text-gray-400 hover:text-white hover:bg-[#253347] rounded-lg px-3 py-2.5 text-sm flex items-center gap-2.5 transition-colors">
